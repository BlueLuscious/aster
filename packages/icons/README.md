...
an isolated public subpath. `@aster/icons/manifest` provides metadata-only discovery without
loading complete definitions. The package contains no renderer, framework, DOM, filesystem,
