...
/**
 * @description Serialises plain portable values as deterministic TypeScript-compatible literals.
 */
export class TypeScriptValueSerialiser {
  /**
   * @description Serialises one portable value with stable indentation and escaped line separators.
  ...
  serialise(value: unknown): string {
    ...
    if (serialised === undefined) {
      throw new BuildContractError(
        "value",
        "expected a JSON-serialisable portable value",
      );
    }
