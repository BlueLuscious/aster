 ...
 * @property {import("@aster/core").IconDefinition} pointSequenceDefinition - Canonical dense point-sequence definition.
 * @property {import("@aster/core").IconRenderOptions} semanticOptions - Prepared semantic accessibility options.
 * @property {import("@aster/core").IconRenderOptions} overrideOptions - Prepared authorised presentation overrides.
 * @property {import("@aster/core").IconRenderOptions} rtlOptions - Prepared explicit RTL options.
 * @property {import("@aster/core").IconRenderOptions} escapingOptions - Prepared escaping-pressure options.
 */
