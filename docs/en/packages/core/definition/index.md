...
| --- | --- | --- |
| `IconIdentity` | Carries an optional canonical namespace, required icon name, and optional variant. | Used by `IconDefinition`, optional metadata replacement relationships, and Build source descriptors. |
